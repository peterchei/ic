    ...
    private void createAndSetSwingContent(final SwingNode swingNode) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                fMEChartA1.fbuttonBar.getBtZoomIn().setButtonImage(new ImageIcon(getClass().getResource("/zoomin.png")).getImage());
                fMEChartA1.fbuttonBar.getBtZoomOut().setButtonImage(new ImageIcon(getClass().getResource("/zoomout.png")).getImage());
                fMEChartA1.fbuttonBar.getBtMove().setButtonImage(new ImageIcon(getClass().getResource("/move.png")).getImage());
                fMEChartA1.fbuttonBar.getBtInsertLine().setButtonImage(new ImageIcon(getClass().getResource("/line.png")).getImage());
                fMEChartA1.fbuttonBar.getBtInsertPLine().setButtonImage(new ImageIcon(getClass().getResource("/parallelline.png")).getImage());
                fMEChartA1.fbuttonBar.getBtGPartition().setButtonImage(new ImageIcon(getClass().getResource("/goldenline.png")).getImage());
                fMEChartA1.fbuttonBar.getBtRemoveLine().setButtonImage(new ImageIcon(getClass().getResource("/undo.png")).getImage());
                fMEChartA1.fbuttonBar.getBtClear().setButtonImage(new ImageIcon(getClass().getResource("/clean.png")).getImage());
                fMEChartA1.fbuttonBar.getBtCompare().setButtonImage(new ImageIcon(getClass().getResource("/percentage.png")).getImage());
                ...
                fMEChartA1.chartOptionBar1.btStock.setButtonImage(new ImageIcon(getClass().getResource("/chartTypeA.png")).getImage());
                fMEChartA1.chartOptionBar1.btTA.setButtonImage(new ImageIcon(getClass().getResource("/chartTypeB.png")).getImage());
                fMEChartA1.chartOptionBar1.btVolume.setButtonImage(new ImageIcon(getClass().getResource("/chartTypeC.png")).getImage());
                fMEChartA1.btOpenClose.setButtonImage(new ImageIcon(getClass().getResource("/close.png")).getImage());
                fMEChartA1.btPrinter.setButtonImage(new ImageIcon(getClass().getResource("/print.png")).getImage());
