                ...
                case GOLDENPARTITION:
                    ...
                    if (actionCommand.isProcessing() == true) {
                        ...
                        if (cchart != null) {
                            ...
                            g.setColor(cchart.getFirstColor());
                            if (cchart.getChartType() == ChartType.PERCENTAGE) {
                                g.drawString(FormatUtil.format2DecimalPlace(v100) + "%", actionCommand.getStartMousePoint().x + 40, MinY - 1);
                                g.drawString(FormatUtil.format2DecimalPlace(v618) + "%", actionCommand.getStartMousePoint().x + 40, Y618 - 1);
                                g.drawString(FormatUtil.format2DecimalPlace(v500) + "%", actionCommand.getStartMousePoint().x + 40, Y50 - 1);
                                g.drawString(FormatUtil.format2DecimalPlace(v382) + "%", actionCommand.getStartMousePoint().x + 40, Y382 - 1);
                                g.drawString(FormatUtil.format2DecimalPlace(v000) + "%", actionCommand.getStartMousePoint().x + 40, MaxY - 1);
                            } else {
                                g.drawString(FormatUtil.format2DecimalPlace(v100), actionCommand.getStartMousePoint().x + 40, MinY - 1);
                                g.drawString(FormatUtil.format2DecimalPlace(v618), actionCommand.getStartMousePoint().x + 40, Y618 - 1);
                                g.drawString(FormatUtil.format2DecimalPlace(v500), actionCommand.getStartMousePoint().x + 40, Y50 - 1);
                        ...
                        if (cchart != null) {
                            ...
                            g.setColor(cchart.getFirstColor());
                            if (cchart.getChartType() == ChartType.PERCENTAGE) {
                                g.drawString(FormatUtil.format2DecimalPlace(v100) + "%", actionCommand.getStartMousePoint().x + 80, MinY - 1);
                                g.drawString(FormatUtil.format2DecimalPlace(v618) + "%", actionCommand.getStartMousePoint().x + 80, Y618 - 1);
                                g.drawString(FormatUtil.format2DecimalPlace(v500) + "%", actionCommand.getStartMousePoint().x + 80, Y50 - 1);
                                g.drawString(FormatUtil.format2DecimalPlace(v382) + "%", actionCommand.getStartMousePoint().x + 80, Y382 - 1);
                                g.drawString(FormatUtil.format2DecimalPlace(v000) + "%", actionCommand.getStartMousePoint().x + 80, MaxY - 1);
                            } else {
                                g.drawString(FormatUtil.format2DecimalPlace(v100), actionCommand.getStartMousePoint().x + 80, MinY - 1);
                                g.drawString(FormatUtil.format2DecimalPlace(v618), actionCommand.getStartMousePoint().x + 80, Y618 - 1);
                                g.drawString(FormatUtil.format2DecimalPlace(v500), actionCommand.getStartMousePoint().x + 80, Y50 - 1);
...
//////plot the Axis/////////////////////////////////////////////////////////////////////////
    ...
    private void drawWatchAction() {
        ...
        if (leftChart.getChartType() == ChartType.VOLUME) {
            ...
            g.drawString(FormatUtil.format3DecimalPlace(pointedValue) + "%", actionCommand.getCurrentMousePoint().x, actionCommand.getCurrentMousePoint().y);
        } else {
            g.drawString(FormatUtil.format3DecimalPlace(pointedValue), actionCommand.getCurrentMousePoint().x + 1, actionCommand.getCurrentMousePoint().y);
        }
