...
import teletext.data.FPoint;
import teletext.data.FTAPoint;
...
//Define of Resolution and display information
    ...
    public boolean addChart(ChartItem newChart) {
        ...
        for (int i = 0; i < this.chartObjects.size(); i++) {
            ChartItem cchart = (ChartItem) chartObjects.elementAt(i);
            if (cchart.chartData.data.size() > tempNumb) {
                tempNumb = cchart.chartData.data.size();
            }
        }
    ...
    private FBound getAxisBound(AxisType axisBarType) {
        ...
        for (int i = 0; i < chartObjects.size(); i++) {
            ...
            if (cchart.chartType == ChartType.SIMPLE_MOVING_AVERAGE || cchart.chartType == ChartType.WEIGHTED_MOVING_AVERAGE || cchart.chartType == ChartType.EXPONENTIAL_MOVING_AVERAGE) {
                double Max = cchart.chartData.getMaximum(startDisplayIndex, endDisplayIndex, "STOCK");
                if (Max > bStockMax) {
                    bStockMax = Max;
                }
        ...
        for (int i = 0; i < chartObjects.size(); i++) {
            ...
            if (cchart.chartType == ChartType.PERCENTAGE && axisBarType == AxisType.LEFTAXIS) {
                cchart.chartBound = newBound;
            }
        }
        return newBound;
...
//////plot the Axis/////////////////////////////////////////////////////////////////////////
        ...
        if (cchart != null) {
            ...
            switch (cchart.chartType) {
                ...
                case MACD:
                    ...
                    g.setColor(cchart.firstColor);
                    g.drawString("MACD1: " + FormatUtil.formatData3(fTApoint.MACD1), x + 1, y + 12);
                    g.drawString("MACD2: " + FormatUtil.formatData3(fTApoint.MACD2), x + 1, y + 24);
                    g.drawString("Diff: " + FormatUtil.formatData3(fTApoint.MACDdiff), x + 1, y + 36);
                ...
                case RSI:
                    ...
                    g.setColor(cchart.firstColor);
                    g.drawString("RSI: " + FormatUtil.formatData3(fTApoint.RSI), x + 1, y + 12);
                ...
                case STC:
                    ...
                    g.setColor(cchart.firstColor);
                    g.drawString("%K: " + FormatUtil.formatData3(fTApoint.K), x + 1, y + 12);
                    g.drawString("%D: " + FormatUtil.formatData3(fTApoint.D), x + 1, y + 24);
                ...
                case OBV:
                    ...
                    g.fill3DRect(x, y, 170, 28, true);
                    g.setColor(cchart.firstColor);
                    g.drawString("OBV: " + FormatUtil.formatData3(fTApoint.OBV), x + 1, y + 12);
                    g.drawString(sDate, x + 1, y + 24);
                    break;
                ...
                case WILLIAM_R:
                    ...
                    g.fill3DRect(x, y, 170, 28, true);
                    g.setColor(cchart.firstColor);
                    g.drawString("William %R: " + FormatUtil.formatData3(fTApoint.R), x + 1, y + 12);
                    g.drawString(sDate, x + 1, y + 24);
                    break;
    ...
    private void plotMovingAverage(ChartItem currentChart) {
        ...
        if (currentChart.chartType == ChartType.SIMPLE_MOVING_AVERAGE) {
        ...
        } else if (currentChart.chartType == ChartType.WEIGHTED_MOVING_AVERAGE) {
        ...
        } else if (currentChart.chartType == ChartType.EXPONENTIAL_MOVING_AVERAGE) {
            N1 = 0;
            N2 = 0;
            N3 = 0;
        } else {
...
//                        String dateMY =  fpoint.Month + "-" + fpoint.Year;
            ...
            } else if (currentChart.chartData.dataType == ChartData.WEEKLY) {
                for (int i = startDisplayIndex; i < dpoint; i++) {
                    int j = Math.max(i - 1, startDisplayIndex);
                    FPoint fpoint = (FPoint) currentChart.chartData.data.elementAt(i);
                    FPoint fpoint2 = (FPoint) currentChart.chartData.data.elementAt(j);
            ...
            } else if (currentChart.chartData.dataType == ChartData.MONTHLY) {
                for (int i = startDisplayIndex; i < dpoint; i++) {
            ...
            } else if (currentChart.chartData.dataType == ChartData.INTRADAY) {
                for (int i = startDisplayIndex; i < dpoint; i++) {
                    int j = Math.max(i - 1, startDisplayIndex);
                    FPoint fpoint = (FPoint) currentChart.chartData.data.elementAt(i);
        ...
        if (lcchart != null && lcchart.chartType == ChartType.PERCENTAGE) {
            ...
            for (int i = 0; i < chartObjects.size(); i++) {
                ...
                if (cchart.chartType == ChartType.PERCENTAGE) {
                    ...
                    String slabel = FormatUtil.getCode(cchart.chartData.Code) + " " + Name;
    ...
    private void drawLabel(ChartItem currentChart) {
        ...
        Graphics g = allscreenImage.getGraphics();
        if (currentChart.axisBar == AxisType.LEFTAXIS) {
            if (currentChart.chartType == ChartType.BAR || currentChart.chartType == ChartType.LINE || currentChart.chartType == ChartType.CANDLE) {
                ...
                g.drawString(FormatUtil.getCode(currentChart.chartData.Code) + " " + cname, leftSpace, 18);
            }

            if (currentChart.chartType == ChartType.PERCENTAGE) {
                g.setColor(currentChart.firstColor);
                FPoint fpoint = (FPoint) currentChart.chartData.data.elementAt(startDisplayIndex);
                String sdate = "";
        ...
        if (currentChart.chartType == ChartType.VOLUME) {
            g.drawString(FormatUtil.getCode(currentChart.chartData.Code) + " " + lbArray[9][language], leftSpace, 18);
        } else if (currentChart.chartType == ChartType.MACD) {
            String tempString;
            tempString = FormatUtil.getCode(currentChart.chartData.Code) + " " + lbArray[20][language];
        ...
        } else if (currentChart.chartType == ChartType.SIMPLE_MOVING_AVERAGE) {
            String tempString;
            g.setColor(FConfig.MAColor1);
            ...
            g.drawString(FormatUtil.getCode(currentChart.chartData.Code) + " " + lbArray[17][language], leftSpace, 18);
            String tempString;
            ...
            g.drawString(FormatUtil.getCode(currentChart.chartData.Code) + " " + lbArray[19][language], leftSpace, 18);
        } else if (currentChart.chartType == ChartType.STC) {
            g.drawString(FormatUtil.getCode(currentChart.chartData.Code) + " " + lbArray[18][language], leftSpace, 18);
            String tempString;
        ...
        } else if (currentChart.chartType == ChartType.WILLIAM_R) {
            String tempString = FormatUtil.getCode(currentChart.chartData.Code) + " " + lbArray[21][language];
    ...
    private synchronized void plotYAxis(ChartItem currentChart, boolean isLabel) {
        ...
        if (currentChart.chartBound == null) {
            return;
        }
        if (gridColor == null) {
            gridColor = new Color(200, 200, 200);
        ...
        if (currentChart.chartType == ChartType.RSI || currentChart.chartType == ChartType.STC || currentChart.chartType == ChartType.WILLIAM_R) {
            sg = 0.0f;
            ddiv = 20f;
        }
        ...
        if (currentChart.axisBar == AxisType.LEFTAXIS) {
            for (; sg <= Max; sg = sg + ddiv) {
                ...
                if (currentChart.chartType == ChartType.VOLUME) {
                    ...
                    ss = FormatUtil.formatInteger(sg) + "%";
                } else if (currentChart.chartType == ChartType.RSI || currentChart.chartType == ChartType.STC || currentChart.chartType == ChartType.WILLIAM_R) {
        ...
        } else if (currentChart.axisBar == AxisType.RIGHTAXIS) {
            for (; sg < Max; sg = sg + ddiv) {
                if (sg < Min || sg > Max) {
                    continue;
                }
...
///// Handle insert line action //////////////////////////////////////////////////////////////////
    ...
    public ChartItem getLeftChart() {
        for (int i = 0; i < chartObjects.size(); i++) {
            ChartItem cchart = (ChartItem) chartObjects.elementAt(i);
            if (cchart.axisBar == AxisType.LEFTAXIS) {
                return cchart;
            }
        }
        return null;
    ...
    public ChartItem getRightChart() {
        for (int i = 0; i < chartObjects.size(); i++) {
            ChartItem cchart = (ChartItem) chartObjects.elementAt(i);
            if (cchart.axisBar == AxisType.RIGHTAXIS) {
                return cchart;
            }
        }
        return null;
