...
public class DealSellPanel extends JPanel {
    ...
    JButton jbSell = new JButton();
    JButton jbCanel = new JButton();

    public DealSellPanel() {
        try {
            jbInit();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void jbInit() throws Exception {
        ...
        titledBorder2 = new TitledBorder(BorderFactory.createLineBorder(Color.black, 1), "Deal Sell");
        ...
        lbPrice.setBounds(new Rectangle(64, 87, 61, 18));
        lbPrice.setText("Sell Price");
        lbPrice.setToolTipText("");
        lbAmount.setBounds(new Rectangle(64, 153, 54, 18));
        lbAmount.setText("Amount");
        lbAmount.setToolTipText("");
        jbSell.setBackground(FConfig.ScreenBackground);
        jbSell.setBounds(new Rectangle(122, 182, 47, 22));
        jbSell.setBorder(border1);
        jbSell.setText("Sell");
