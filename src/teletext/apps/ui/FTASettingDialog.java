...
public class FTASettingDialog extends JFrame implements WindowListener {
	...
	void btRSIApply_actionPerformed(ActionEvent e) {
		...
		if (taChart.chartType == ChartType.RSI) {
			taChart.chartData
					.calculateRSI(taChart.chartData.fTAconfig.RSIPeriod);
	...
	void btMACDApply_actionPerformed(ActionEvent e) {
		...
		if (taChart.chartType == ChartType.MACD) {
	...
	void btSTCApply_actionPerformed(ActionEvent e) {
		...
		if (taChart.chartType == ChartType.STC) {
	...
	void btWilliamApply_actionPerformed(ActionEvent e) {
		...
		if (taChart.chartType == ChartType.WILLIAM_R) {
	...
	void updateSetting() {
		...
		this.tfRSI.setText(String
				.valueOf(currentChart.chartData.fTAconfig.RSIPeriod));
		this.tfSTCK.setText(String
				.valueOf(currentChart.chartData.fTAconfig.STCKPeriod));
		this.tfSTCD.setText(String
				.valueOf(currentChart.chartData.fTAconfig.STCDPeriod));
		this.tfWR.setText(String
				.valueOf(currentChart.chartData.fTAconfig.WilliamPeriod));
		this.tfEAMA.setText(String
				.valueOf(currentChart.chartData.fTAconfig.MACDAEMA));
		this.tfELMA.setText(String
				.valueOf(currentChart.chartData.fTAconfig.MACDLEMA));
		this.tfESMA.setText(String
				.valueOf(currentChart.chartData.fTAconfig.MACDSEMA));
	}
