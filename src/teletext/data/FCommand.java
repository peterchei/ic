...
public class FCommand {
    ...
    public ChartData getYahooDailyData() {
        ...
        try {
            ...
            newChartData.EName = StockInfoStore.getInstance().getStockName(String.valueOf(code));
            newChartData.CName = StockInfoStore.getInstance().getStockName(String.valueOf(code));
